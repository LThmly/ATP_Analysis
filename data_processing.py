...
grass_stats.plot(x='player', y='grass_wins', kind='bar',color='#269281',title='ATP Match Wins on Grass Courts (Open Era)')
plt.tight_layout()
clay_stats.plot(x='player', y='clay_wins', kind='bar',color='#269281',title='ATP Match Wins on Clay Courts (Open Era)')
plt.tight_layout()
hard_stats.plot(x='player', y='hard_wins', kind='bar',color='#269281',title='ATP Match Wins on Hard Courts (Open Era)')
plt.tight_layout()
total_stats.plot(x='player', y='total_wins', kind='bar',color='#269281',title='ATP Match Wins on All Courts (Open Era)')
plt.tight_layout()
...
fig1 = sns.boxplot(data=df['winner_age'],orient='h',width=.5,fliersize=2,linecolor="#000000",color="#269281")
fig1.set(title='Age of ATP Match Winners',ylabel='',xlabel='Years')
plt.show()

print(avg_win_age,oldest_win_age,oldest_winner,youngest_win_age,youngest_winner,sep='\n')
...
fig2 = sns.barplot(data=country_win_stats[:20],orient='h',color="#269281")
...
colors = [(0.14901960784313725, 0.5725490196078431, 0.5058823529411764), (.9, .9, .9)] 
